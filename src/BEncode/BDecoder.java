...
public class BDecoder {
	...
	private long getNumberFromStreamOld(InputStream bais, char parseChar)
		...
		CharBuffer cb = Constants.DEFAULT_CHARSET.decode(ByteBuffer
				.wrap(tempArray));
	...
	public static void main(String[] args) {
		...
		print(new File(
				"/home/argi/Dev/BitTorrentClient/data/Nurses 2 XXX - CD2.torrent"),
				new File("/home/argi/Dev/BitTorrentClient/data/Nurses 2 XXX - CD2.log"));
	}
}